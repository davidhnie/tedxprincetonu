...
<body>
    ...
    <div class="panel" id="panel-1">
    	<div class="panel-inner">
    		<h2 style="font-size: 8em; text-align: center;">Catalyst</h2>
			...
			<ol>
            	<li style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; font-size: 1.3em;">An innovative person or idea that prompts action and accelerates change.</li>
            </ol>
